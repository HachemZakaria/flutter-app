...
import 'payments_classes_screen.dart';
import 'student_payments_screen.dart';
import 'branches_screen.dart';

class PaymentsLevelsScreen extends StatelessWidget {
  final String cycle;

  const PaymentsLevelsScreen({super.key, required this.cycle});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('${tr('payments')} - ${_getCycleTranslated(cycle)}'),
              ...
              onTap: () {
                if (hasBranches) {
                    ...
                    MaterialPageRoute(
                      builder: (_) => BranchesScreen(
                        ...
                        classScreenBuilder: (cycle, level, className) {
                          // ✅ Ouvre directement les paiements de la classe
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          PaymentsClassesScreen(cycle: cycle, level: level),
                    ),
                  );
                }
              },
