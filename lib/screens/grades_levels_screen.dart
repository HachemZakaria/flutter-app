...
import 'grades_classes_screen.dart';
import 'grades_subjects_screen.dart';
import 'branches_screen.dart';

class GradesLevelsScreen extends StatelessWidget {
  final String cycle;

  const GradesLevelsScreen({super.key, required this.cycle});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('${tr('grades')} - ${_getCycleTranslated(cycle)}'),
              ...
              onTap: () {
                if (hasBranches) {
                    ...
                    MaterialPageRoute(
                      builder: (_) => BranchesScreen(
                        ...
                        classScreenBuilder: (cycle, level, className) {
                          // ✅ Ouvre directement les matières de la classe
                          return GradesSubjectsScreen(
                            cycle: cycle,
                            level: level,
                            className: className,
                          );
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          GradesClassesScreen(cycle: cycle, level: level),
                    ),
                  );
                }
              },
