...
import 'payments_levels_screen.dart';

class PaymentsCyclesScreen extends StatelessWidget {
  const PaymentsCyclesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${tr('payments')} - ${tr('choose_cycle')}'),
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => PaymentsLevelsScreen(cycle: cycle),
                  ),
                );
              },
              child: Container(
