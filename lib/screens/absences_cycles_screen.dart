...
import 'absences_levels_screen.dart';

class AbsencesCyclesScreen extends StatelessWidget {
  const AbsencesCyclesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${tr('absences')} - ${tr('choose_cycle')}'),
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => AbsencesLevelsScreen(cycle: cycle),
                  ),
                );
              },
              child: Container(
